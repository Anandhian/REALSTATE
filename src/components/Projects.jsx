...
const Projects = () => {
    ...
    const [cardsTOShow,setCardsShow]=useState(1)
    const nextProject=()=>{
  ...
  return (
    ...
    viewport={{once:true}}  className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
        <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center '>Projects<span className='underline underline-offset-4 decoration-1 under font-light'>Compleated</span></h1>
        <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Crafting Spaces ,Bulding Legacies_Explore Our Portfolio</p>
                ...
                <div className='absolute left-0 right-0 bottom-5 flex justify-center'>
                    ...
                    <h2 className='text-xl font-semibold text-gray-800'>
                        ...
                        <p className='text-gray-500 text-sm'>
                            {Project.price}<span className='px-1'>|</span>{Project.location}</p></div>
                </div>
            </div>
